...
const HeroSection: React.FC = () => {
  ...
  // Voice introduction function with more personality
      ...
      <div className="absolute inset-0 z-5 overflow-hidden pointer-events-none">
        {techIcons.map((tech, index) => (
          <motion.div
            ...
            className="absolute text-gray-400 dark:text-gray-600 flex flex-col items-center"
          >
            {tech.icon}
      ...
      <div className="container mx-auto px-6 z-20 relative">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-extrabold mb-6 tracking-tight text-center relative z-10"
          >
            <span className="hero-text-gradient">
              Anshumesh Saini
            </span>
            <span className="absolute -z-10 top-1/2 left-1/2 w-[120%] h-[120%] transform -translate-x-1/2 -translate-y-1/2 blur-3xl opacity-30 bg-gradient-to-r from-indigo-500 via-sky-400 to-emerald-400 rounded-full animate-pulse" />
          </motion.h1>
          ...
          >
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-center relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-400">
              Full-Stack Developer & AI Specialist
            </h2>
            <motion.div 
              className="absolute -bottom-2 left-1/2 h-1 w-20 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full"
          ...
          <motion.div
            ...
            className="relative"
          >
            <p className="text-lg md:text-xl leading-relaxed text-center max-w-3xl mx-auto mb-12 px-4 text-gray-700 dark:text-gray-300">
              <span className="">
                Digital architect
              </span> crafting immersive experiences with{" "}
              <span className="">
                cutting-edge tech
              </span>. Specializing in{" "}
              <span className="">
                scalable solutions
              </span> that blend aesthetics with{" "}
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 relative z-20"
          >
            ...
            <motion.button
              ...
              className="relative px-8 py-3 text-white bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl font-semibold shadow-lg transition-all duration-300 overflow-hidden group"
            >
              ...
              <span className="absolute inset-0 rounded-xl overflow-hidden">
                <span className="absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-transparent" />
                <span className="absolute top-0 right-0 w-0.5 h-full bg-gradient-to-b from-transparent animate-border-right" />
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-transparent animate-border-bottom" />
                <span className="absolute top-0 left-0 w-0.5 h-full bg-gradient-to-b from-transparent animate-border-left" />
              </span>
            </motion.button>
            ...
            <motion.button
              ...
              className="relative px-8 py-3 text-white bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl font-semibold shadow-lg transition-all duration-300 overflow-hidden group"
            >
